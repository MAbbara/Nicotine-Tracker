...
Note: This script assumes a test user with email 'test@example.com' and
password 'password123' exists.

This module intentionally does not use pytest's ``test_*.py`` naming. Importing
Locust applies gevent monkey patches that corrupt subprocess handling when the
regular pytest suite merely collects the load-test entry point.
"""
