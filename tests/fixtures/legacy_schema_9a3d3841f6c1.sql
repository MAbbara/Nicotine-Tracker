-- legacy_schema_9a3d3841f6c1.sql
--
-- Fixed synthetic fixture: a real revision-9a3d3841f6c1 schema and stamp.
-- Authored against the DDL produced by migrating an EMPTY temporary database
-- to 9a3d3841f6c1; every row below is fixed synthetic data (reserved domain
-- example.invalid, placeholder password hash). No instance database was
-- copied, dumped, mutated, or exported to create this file.
--
-- Manifest: four users (notification_channel 'email', 'discord', 'both',
-- 'none'); representative pouch/log/craving/notification/active-goal rows
-- attached to user 1; pouch 1 carries the fractional strength 1.5 (stored as
-- a REAL inside the INTEGER-affinity column) so the upgrade must prove it is
-- not truncated.
...
CREATE TABLE user_preferences (
	...
	notification_channel VARCHAR(20) DEFAULT 'email' NOT NULL,
	PRIMARY KEY (id),
	UNIQUE (user_id),
...
-- Fixed synthetic manifest ---------------------------------------------------

INSERT INTO "user" (id, email, password_hash, created_at, age, gender, weight, email_verified, preferred_brands, timezone, units_preference) VALUES
  (1, 'synthetic-alice@example.invalid', 'synthetic-only-not-a-real-password-hash', '2025-01-05 08:00:00.000000', NULL, NULL, NULL, 1, '["SYNTH-ZYN"]', 'UTC', 'mg'),
  (2, 'synthetic-bob@example.invalid', 'synthetic-only-not-a-real-password-hash', '2025-01-05 08:00:00.000000', NULL, NULL, NULL, 1, NULL, 'UTC', 'percentage'),
  (3, 'synthetic-carol@example.invalid', 'synthetic-only-not-a-real-password-hash', '2025-01-05 08:00:00.000000', NULL, NULL, NULL, 1, '["SYNTH-VELO", "SYNTH-ON"]', 'UTC', NULL),
  (4, 'synthetic-dave@example.invalid', 'synthetic-only-not-a-real-password-hash', '2025-01-05 08:00:00.000000', NULL, NULL, NULL, 1, '[]', 'UTC', 'mg');
...
INSERT INTO user_preferences (user_id, created_at, updated_at, goal_notifications, daily_reminders, weekly_reports, achievement_notifications, discord_webhook, slack_webhook, reminder_time, quiet_hours_start, quiet_hours_end, notification_frequency, daily_reset_time, notification_channel) VALUES
  ...
  (3, '2025-01-05 08:00:00.000000', '2025-01-05 08:00:00.000000', 1, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 'immediate', NULL, 'both'),
  (4, '2025-01-05 08:00:00.000000', '2025-01-05 08:00:00.000000', 1, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 'immediate', NULL, 'none');
