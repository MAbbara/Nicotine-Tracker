-- stamp_drift_schema_9a3d3841f6c1.sql
--
-- Fixed synthetic fixture: STAMP DRIFT. The alembic stamp says 9a3d3841f6c1,
-- but the database physically carries the post-6848755d9016 preference
-- structure: notification_channel is already JSON, units_preference and
-- preferred_brands already live on user_preferences, and the user-side
-- preference columns are already gone. This mirrors the schema SHAPE of the
-- checked instance database with fixed synthetic rows only — no instance
-- database was copied, dumped, mutated, or exported to create this file.
--
-- It proves the repaired historical revisions (f8e091ac4f79, 6848755d9016)
-- are safe to replay against already-applied structure: no duplicate columns,
...
-- Post-684... user_preferences shape: JSON notification_channel (with the
-- historical f8... server default, which the reconciliation revision must
-- remove to match ORM metadata), plus units_preference and preferred_brands.
CREATE TABLE user_preferences (
	...
	units_preference VARCHAR(20) NOT NULL,
...
-- Fixed synthetic manifest (post-684... representation) ---------------------
...
INSERT INTO user_preferences (user_id, created_at, updated_at, goal_notifications, daily_reminders, weekly_reports, achievement_notifications, discord_webhook, slack_webhook, reminder_time, quiet_hours_start, quiet_hours_end, notification_frequency, daily_reset_time, notification_channel, units_preference, preferred_brands) VALUES
  (1, '2025-01-05 08:00:00.000000', '2025-01-05 08:00:00.000000', 1, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 'immediate', NULL, '["email"]', 'mg', '["SYNTH-ZYN"]'),
  (2, '2025-01-05 08:00:00.000000', '2025-01-05 08:00:00.000000', 1, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 'immediate', NULL, '["discord"]', 'percentage', NULL),
  (3, '2025-01-05 08:00:00.000000', '2025-01-05 08:00:00.000000', 1, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 'immediate', NULL, '["email", "discord"]', 'mg', '["SYNTH-VELO", "SYNTH-ON"]'),
  (4, '2025-01-05 08:00:00.000000', '2025-01-05 08:00:00.000000', 1, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 'immediate', NULL, '[]', 'mg', '[]');
...
INSERT INTO alembic_version (version_num) VALUES ('9a3d3841f6c1');
