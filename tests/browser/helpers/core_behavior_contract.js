...
const OWNER_TITLES = Object.freeze({
  ...
  journeyOverview: 'tests/browser/journey.spec.js › active Journey keeps the compact mg overview ahead of one deep path and control set',
...
group(OWNER_TITLES.landing, [
  ['landing', 'Add details', 'navigation'],
  ['landing', 'Adjust plan', 'navigation'],
  ['landing', 'After a meal', 'localFocus'],
  ['landing', 'Boredom', 'localFocus'],
  ['landing', 'Coffee', 'localFocus'],
  ['landing', 'Cravings', 'navigation'],
  ['landing', 'Create account', 'navigation'],
  ['landing', 'Create your account', 'navigation'],
  ['landing', 'Do I have to quit completely to use this?', 'localFocus'],
  ['landing', 'Driving', 'localFocus'],
  ['landing', 'Export your data', 'navigation'],
  ['landing', 'Having a craving? Pause, note it, and choose what helps next.', 'localFocus'],
  ['landing', 'Insights', 'navigation'],
  ['landing', 'Intensity 1', 'localFocus'],
  ['landing', 'Intensity 2', 'localFocus'],
  ['landing', 'Intensity 3', 'localFocus'],
  ['landing', 'Intensity 4', 'localFocus'],
  ['landing', 'Intensity 5', 'localFocus'],
  ['landing', 'Intensity 6', 'localFocus'],
  ['landing', 'Intensity 7', 'localFocus'],
  ['landing', 'Intensity 8', 'localFocus'],
  ['landing', 'Intensity 9', 'localFocus'],
  ['landing', 'Intensity 10', 'localFocus'],
  ['landing', 'Is it only for nicotine pouches?', 'localFocus'],
  ['landing', 'It passed', 'localFocus'],
  ['landing', 'Log one anyway', 'localFocus'],
  ['landing', 'On! 4 mg', 'localFocus'],
  ['landing', 'Privacy & your data', 'navigation'],
  ['landing', 'See how it works', 'navigationFragment'],
  ['landing', 'Sign in', 'navigation'],
  ['landing', 'Stress', 'localFocus'],
  ['landing', 'Today', 'navigation'],
  ['landing', 'Velo 6 mg', 'localFocus'],
  ['landing', 'What does it cost?', 'localFocus'],
  ['landing', 'What happens when I go over my plan?', 'localFocus'],
  ['landing', 'Will it nag me with notifications?', 'localFocus'],
  ['landing', 'With alcohol', 'localFocus'],
  ['landing', 'Your plan', 'navigation'],
  ['landing', 'ZYN 3 mg', 'localFocus'],
]);
...
group(OWNER_TITLES.journeyOverview, [
  ['journey', '1 September: nicotine ceiling changes to 33.50 mg', 'localFocus'],
  ['journey', '12 August: nicotine ceiling changes to 43.50 mg', 'localFocus'],
  ['journey', '13 September: nicotine ceiling changes to 27.50 mg', 'localFocus'],
  ['journey', '16 August: nicotine ceiling changes to 41.50 mg', 'localFocus'],
  ['journey', '17 September: nicotine ceiling changes to 25.50 mg', 'localFocus'],
  ['journey', '20 August: nicotine ceiling changes to 39.50 mg', 'localFocus'],
  ['journey', '24 August: nicotine ceiling changes to 37.50 mg', 'localFocus'],
  ['journey', '28 August: nicotine ceiling changes to 35.50 mg', 'localFocus'],
  ['journey', '4 August: nicotine ceiling changes to 47.50 mg', 'localFocus'],
  ['journey', '5 September: nicotine ceiling changes to 31.50 mg', 'localFocus'],
  ['journey', '8 August: nicotine ceiling changes to 45.50 mg', 'localFocus'],
  ['journey', '9 September: nicotine ceiling changes to 29.50 mg', 'localFocus'],
]);
