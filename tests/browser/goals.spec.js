...
test('Goals preserve create, edit, toggle, and delete behavior', async ({ page }, testInfo) => {
  ...
  await recorder.runScenario(
    page, 'goal-create', 'Notify me as I approach this goal', 'toggle',
  );
  await recorder.runScenario(
    page, 'goal-create', 'Create goal', 'invalid', 'success',
  );
  ...
  await recorder.runScenario(page, 'goal-edit', 'Keep this goal active', 'toggle');
  await activeCheckbox.press('Space');
  await expect(activeCheckbox).toBeChecked();
  await recorder.runScenario(
    page, 'goal-edit', 'Notify me as I approach this goal', 'toggle',
  );
  await recorder.runScenario(
    page, 'goal-edit', 'Save changes', 'invalid', 'success',
  );
  ...
  await recorder.runScenario(page, 'goals', 'Delete goal', 'dismiss', 'accept');
